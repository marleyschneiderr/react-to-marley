...
const Programs = () => {
  return (
    <div id="skills" name="Programs" className="w-full h-screen bg-[#2d00f7] text-white">
      <div className="max-w-[1010px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div>
          <p className="text-4xl font-bold inline border-b-4 border-[#E500A4]">Program Skills</p>
