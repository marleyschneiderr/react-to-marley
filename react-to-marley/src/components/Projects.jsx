...
const Projects = () => {
  return (
    <div id="portfolio" name="Projects" className="w-full md:h-screen text-white bg-[#2d00f7]">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 text-white-300 border-[#E500A4]">
            Portfolio
          </p>
